...
RT_mooring_data_path = (RT_data_path / 'Rockall_Trough_moorings_time_series_2014_2024')
prep_RT_mooring_data_path = (local_data_dir/'04_afox_Rockall_Trough_moorings_data_prep_2014_2024_v1/')
RT_transport_data_path_v0 = (local_data_dir/'05_afox_Rockall_Trough_transports_2014_2024_v1/')
RT_transport_data_path_v1 = (local_data_dir/'06_Rockall_Trough_transports_2014_2022_v1/')
