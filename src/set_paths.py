...
glider_data_path = (one_drive_data_dir/ 'data_seaglider/2024_SE_Glider')
glider_data_path_nc = (one_drive_data_dir/ 'data_seaglider/2025_SE_Glider')
...
glider_nc_fn = 'glider_sections_gridded_20251129.nc'
...
NAO_fn = 'norm.daily.nao.cdas.z500.19500101_current.csv'
EAP_fn = 'data.nc'